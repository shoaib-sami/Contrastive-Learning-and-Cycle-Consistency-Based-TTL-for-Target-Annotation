...
class QSModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if opt.nce_idt and self.isTrain:
            ...
            self.loss_names += ['cycle_CA','cycle_CB','NCE2','NCE3','D','idt_A','idt_B','D1','clf1','clf2'] #'cycle_A','cycle_B',
        ...
        self.netGB = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, opt.netG, opt.normG, not opt.no_dropout, opt.init_type, opt.init_gain, opt.no_antialias, opt.no_antialias_up, self.gpu_ids, opt)
        ...
        PATH2 = '/media/shoaibmerajsami/SMS/ATR_database_october_2021/cycle_gan_july_2022_final/Modified_CUT_sep12/checkpoints/grumpycat_CUT_sep_17_cycle_V1/4_net_G (copy).pth'
        ...
        print('...................................................................................')
        print(PATH2)
        PATHB = '/media/shoaibmerajsami/SMS/ATR_database_october_2021/cycle_gan_july_2022_final/Modified_CUT_sep12/checkpoints/grumpycat_CUT_sep_17_cycle_V1/4_net_GB (copy).pth'
        ...
        self.netF = networks.define_F(opt.input_nc, opt.netF, opt.normG, not opt.no_dropout, opt.init_type, opt.init_gain, opt.no_antialias, self.gpu_ids, opt)
        PATHF = '/media/shoaibmerajsami/SMS/ATR_database_october_2021/cycle_gan_july_2022_final/Modified_CUT_sep12/checkpoints/grumpycat_CUT_sep_15_cycle_V1/6_net_F.pth'
        print(PATHF)
  
        #self.netF.load_state_dict(torch.load(PATHF),strict=False)
        self.netFB = networks.define_F(opt.input_nc, opt.netF, opt.normG, not opt.no_dropout, opt.init_type, opt.init_gain, opt.no_antialias, self.gpu_ids, opt)
        PATHFB = '/media/shoaibmerajsami/SMS/ATR_database_october_2021/cycle_gan_july_2022_final/Modified_CUT_sep12/checkpoints/grumpycat_CUT_sep_15_cycle_V1/6_net_FB.pth'
        print(PATHFB)
        """
    ...
    def forward(self):
        ...
        self.rec_A = self.netGB(self.fake_B)   # G_B(G_A(A))
    ...
    def compute_G_loss(self):
        ...
        self.classification_loss2 = self.criterion2(self.scores2_fake_B,self.labela)*5
        #self.classification_loss3 = self.criterion3(self.scores3,self.labelb)*0.2
        self.classification_loss4 = self.criterion4(self.scores4,self.labelb)*5
        ...
        self.loss_idt_A = self.calculate_NCE_loss(self.idt_A1, self.real_A) * .5#lambda_B * lambda_idt
        # G_B should be identity if real_A is fed: ||G_B(A) - A||
        #self.idt_B = self.netGB(self.real_A)
        self.loss_idt_B = self.calculate_NCE_lossB(self.idt_B1, self.real_B) *.5 #lambda_A * lambda_idt
        ...
        self.loss_cycle_CA = self.calculate_NCE_lossB( self.real_A, self.rec_A) 
        self.loss_cycle_CB = self.calculate_NCE_loss(self.real_B, self.rec_B) 
        ...
        self.loss_G = self.loss_G_GAN + loss_NCE_both + loss_NCE_both2 + self.loss_G_B + self.loss_idt_A + self.loss_idt_B+self.loss_NCE_both_cycle # + self.loss_cycle_A + self.loss_cycle_B 
        ...
        if self.iteration % 5000 ==2:
            ...
            print("NCE loss Both Cycle")
            print(self.loss_NCE_both_cycle)
